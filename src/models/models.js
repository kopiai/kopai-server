...
const Roasting = sequelize.define('Roasting', {
  roasting_id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
const Grinding = sequelize.define('Grinding', {
  grinding_id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
const Blend = sequelize.define('Blend', {
  ...
  coffee_id1: { type: DataTypes.INTEGER, references: { model: 'Coffee', key: 'coffee_id' } },
  coffee_id2: { type: DataTypes.INTEGER, references: { model: 'Coffee', key: 'coffee_id' } },
  percentage: { type: DataTypes.INTEGER, allowNull: false },
  ukuran_gram: { type: DataTypes.INTEGER, allowNull: false },
  roast_id: { type: DataTypes.INTEGER, references: { model: 'Roasting', key: 'roasting_id' } },
  grind_id: { type: DataTypes.INTEGER, references: { model: 'Grinding', key: 'grinding_id' } },
