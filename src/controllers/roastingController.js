...
const RoastingController = {
  createRoasting: async (req, res) => {
    try {
      ...
      return res.status(201).json({ message: 'Roasting created successfully', roasting: newRoasting });
    } catch (err) {
  ...
  updateRoasting: async (req, res) => {
    ...
    try {
      ...
      return res.status(200).json({ message: 'Roasting updated successfully', roasting });
    } catch (err) {
