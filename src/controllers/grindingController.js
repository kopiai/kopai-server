...
const GrindingController = {
  createGrinding: async (req, res) => {
    try {
      ...
      return res.status(201).json({ message: 'Grinding created successfully', grinding: newGrinding });
    } catch (err) {
  ...
  updateGrinding: async (req, res) => {
    ...
    try {
      ...
      return res.status(200).json({ message: 'Grinding updated successfully', grinding });
    } catch (err) {
